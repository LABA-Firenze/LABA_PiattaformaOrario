        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              ...
              className="flex items-center gap-2 px-3 sm:px-5 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm sm:text-base font-medium transition-colors border border-gray-200 whitespace-nowrap"
            >
